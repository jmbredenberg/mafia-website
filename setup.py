...
execfile(os.path.join("mafia", "release.py"))

packages = find_packages()
package_data = find_package_data(where='mafia',
    package='mafia')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-mafia = mafia.command:start',
            # See the mafia.command.bootstrap function for details
